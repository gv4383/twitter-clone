...
class TweetCell: DatasourceCell {
    ...
    let retweetButton: UIButton = {
        let button = UIButton(type: .system)
        button.setImage(UIImage(named: "retweet")?.withRenderingMode(.alwaysTemplate), for: .normal)
        button.tintColor = .lightGray
    ...
    let directMessageButton: UIButton = {
        let button = UIButton(type: .system)
        button.setImage(UIImage(named: "send_message")?.withRenderingMode(.alwaysTemplate), for: .normal)
        button.tintColor = .lightGray
